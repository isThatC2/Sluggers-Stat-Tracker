...
class Outputter:
    ...
    def _stats_stat_specs(self):
        return [
            ...
            ("Double Plays Hit Into", lambda p: p.stats.batting.double_plays_hit_into),
            ("Triple Plays Hit Into", lambda p: p.stats.batting.triple_plays_hit_into),
            ("Buddy Jumps Hit Into", lambda p: p.stats.batting.buddy_jumps_hit_into),
            ("Star Swings", lambda p: p.stats.batting.star_swings),
    ...
    def _stats_total_specs(self):
        return [
            ...
            ("Total Bases", "sum"),
            ("Sac Flys", "sum"),
            ("Double Plays Hit Into", "sum"),
            ("Triple Plays Hit Into", "sum"),
            ("Buddy Jumps Hit Into", "sum"),
            ("Star Swings", "sum"),
            ("Star Hits", "sum"),
            ("Stars Used", "sum"),
